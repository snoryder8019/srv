/**
 * MadLadsLab tenant — custom routes
 * Mounted at /custom (gated to madladslab.madladslab.com only)
 *
 * Views resolve from: views/tenants/madladslab/<template>.ejs
