...
import careersRouter from './admin/careers.js';
...
import engagementsCatalogRouter, { clientRouter as clientEngagementsRouter } from './admin/engagements.js';
...
router.use('/clients/:id/engagements', clientEngagementsRouter);
router.use('/clients', clientsRouter);
router.use('/engagements', engagementsCatalogRouter);
