 ...
 */
async function notifyAdmin({ type = 'signup', app = 'platform', email = '', name = '', data = {}, ip = '', userId = null }) {
  ...
  if (!t) {
    // No transport configured in THIS process — record it instead of vanishing.
