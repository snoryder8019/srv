...
// ── ROULETTE ──
let r = fs.readFileSync('/srv/games/arcade/tiles/public/js/roulette3d.js', 'utf8');
...
else { r = r.replace(oldR, newR); fs.writeFileSync('/srv/games/arcade/tiles/public/js/roulette3d.js', r); console.log('roulette: all bettors show chips'); }

// ── CRAPS ──
let c = fs.readFileSync('/srv/games/arcade/tiles/public/js/craps3d.js', 'utf8');
...
else { c = c.replace(oldC, newC); fs.writeFileSync('/srv/games/arcade/tiles/public/js/craps3d.js', c); console.log('craps: all bettors show chips'); }
