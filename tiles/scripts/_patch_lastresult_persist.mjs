...
let r = fs.readFileSync('/srv/tiles/roulette/index.js', 'utf8');
...
fs.writeFileSync('/srv/tiles/roulette/index.js', r);

// ── CRAPS: persist lastRoll on the match the same way. ──
let c = fs.readFileSync('/srv/tiles/craps/index.js', 'utf8');
...
fs.writeFileSync('/srv/tiles/craps/index.js', c);
